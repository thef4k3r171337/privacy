...
function ConsultaCep(cep, retMethod, elemento) {
    ...
    ConsultaCepSimples(cep, function (data) {
        if (data != null) {
            ...
            AlertaErro("CEP InvÃ¡lido", "Por favor, digite um CEP vÃ¡lido", elemento);
            cepValido = false;
        }
    });
...
var registerEvents = function () {
    ...
    $(".cpf").change(function () {
        if (!TestaCPF($(this).val())) {
            $(this).val("");
            AlertaErro("CPF InvÃ¡lido", "Por favor, digite o CPF corretamente", this);
    ...
    $(".email").change(function () {
        if (!isEmail($(this).val())) {
            $(this).val("");
            AlertaErro("E-MAIL InvÃ¡lido", "Por favor, digite um e-mail vÃ¡lido", this);
            $(this).parent(".control").parent(".field-group").removeClass("is-danger");
        }
    });
